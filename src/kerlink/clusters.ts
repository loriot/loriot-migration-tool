    ...
    case eKerlinkPushConfigurationType.HTTP:
      ...
      const http: LoriotHttpKerlinkOutput = {
        ...
        osetup: {
          ...
          dataup_route: kerlinkPushConfiguration.httpDataUpRoute && kerlinkPushConfiguration.httpDataUpRoute !== '' ? kerlinkPushConfiguration.httpDataUpRoute : '/dataUp',
          datadownevent_route: kerlinkPushConfiguration.httpDataDownEventRoute && kerlinkPushConfiguration.httpDataDownEventRoute !== '' ? kerlinkPushConfiguration.httpDataDownEventRoute : '/dataDownEvent',
    ...
    case eKerlinkPushConfigurationType.MQTT:
      ...
      const mqtt: LoriotMqttKerlinkOutput = {
        ...
        osetup: {
          ...
          user: kerlinkPushConfiguration.user,
          password: kerlinkPushConfiguration.password,
          dataup_topic: kerlinkPushConfiguration.mqttDataUpTopic && kerlinkPushConfiguration.mqttDataUpTopic !== '' ? kerlinkPushConfiguration.mqttDataUpTopic : '/dataUp',
          datadownevent_topic: kerlinkPushConfiguration.mqttDataDownEventTopic && kerlinkPushConfiguration.mqttDataDownEventTopic !== '' ? kerlinkPushConfiguration.mqttDataDownEventTopic : '/dataDownEvent',
